...
import type { Color, GameState, Lesson, Position, Square, StaticMiniGame } from '@chess-kids/core';
import {
  gameResult,
  gameStars,
  playGameMove,
...
export interface StaticBossStepProps {
...
/** A `static` boss mini-game: capture every enemy piece (or collect every star) before the move limit, no hints. */
export function StaticBossStep({
  lesson,
  game: minigame,
  nextStepIndex,
