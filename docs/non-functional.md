...
| Parent gate | Parent password (≥ 4 characters) before parent area, unlocks, limits, reset, external links; stored hashed on device; 5 wrong attempts → 1-minute wait; recovery code |
