...
- **Error:** undo + spoken explanation → hint ladder (piece → target squares → move) → after 2 failures easier variant offered ("Try an easier one"; kid may keep trying) + concept to review. Never blocked.
